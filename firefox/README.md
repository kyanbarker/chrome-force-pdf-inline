# Firefox Extension: Don't Download PDFs
## Formerly known as "Render PDFs Inline"


This is a Firefox extension to force PDFs to render in the browser, instead of downloading.
...
Install this add-on from [Firefox Add-ons](https://addons.mozilla.org/)
